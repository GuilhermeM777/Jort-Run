...
function desenharPersonagem() {
    ...
    objeto.lineTo(personagemX, personagemY + 4 * personagemTamanho);
    objeto.stroke();
    ...
    // Pernas
    objeto.moveTo(personagemX, personagemY + 4 * personagemTamanho);
    objeto.lineTo(personagemX - personagemTamanho, personagemY + 7 * personagemTamanho);
    objeto.moveTo(personagemX, personagemY + 4 * personagemTamanho);
    objeto.lineTo(personagemX + personagemTamanho, personagemY + 7 * personagemTamanho);
    objeto.stroke();
}
